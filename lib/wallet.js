...
var getOrganizationList = require('./network').getOrganizationList;
...
Wallet.prototype.getOrganizationList = function() {
    return getOrganizationList(this.api, orgAddress)
        .then(data => { 
          console.log(data);
          return data; 
        })
...
Wallet.prototype.getFullOrganizationList = function() {
    return [
      {
      organizationGroup: "women",
      top_address: "484737373sjsjjssj",
      organizations: [
          {
            "name": "UNICEFIceland",
            "address": "B4VjJnCNFGEyXWTRmd9nPEzPYeWX35WHWK"
          },
          {
            "name": "TaniaLibraryStore",
            "address": "B8nanvc2io1VRdnDm3Fa6ahf6un8AHJT23"
          },
          {
            "name": "KongoniLibraryStore",
            "address": "B9C8LDYYEPp6WCpU5ycaPWEkH6nK42frrj"
          },
          {
            "name": "MashimoniLibraryStore",
            "address": "BCqPp3TP4gU81WBef3Sv6ncpXetxbFYm4i"
          },
      ]
  },
  {
      organizationGroup: "libraries",
      top_address: "4j4j4kskjddlalksjd",
      organizations: [
          {
            "name": "UNICEFIceland",
            "address": "B4VjJnCNFGEyXWTRmd9nPEzPYeWX35WHWK"
   ...
   {
      organizationGroup: "non profit",
      top_address: "4j4j4ksksdfsdfjddlalksjd",
      organizations: [
          {
            "name": "UNICEFIceland",
            "address": "B4VjJnCNFGEyXWTRmd9nPEzPYeWX35WHWK"
