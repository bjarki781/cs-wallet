...
var getAllOrgLists = require('./network').getAllOrgLists;
...
Wallet.prototype.getOrgLists = function() {
    return this.allOrgLists;
}

Wallet.prototype.getOrganizationList = function(orgAddress) {
...
Wallet.prototype.getAllOrganizationList = function() {
    return getAllOrgLists(this.api)
	.then(data => {
		console.log(data);
		return data;
	})
